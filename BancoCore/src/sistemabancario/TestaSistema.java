...
public class TestaSistema{
	...
	private static void inicializaSistemaBancario() {
		// crindo conta vazia de contas e clientes
		...
		//criando dois clientes e associando as contas criadas acima deles
		
		Cliente cliente01 = new Cliente(1, "Joao da Silva",20, "joaosilva@gmail.com", conta01.getId(),true);
		Cliente cliente02 = new Cliente(2, "Napoleao Siva",56, "napoleaosilva@gmail.com", conta02.getId(),true);
